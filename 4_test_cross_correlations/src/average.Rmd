...
meaning_w <- get_two_sample_wilcoxon(M, N, "two.sided")
constraint_w <- get_two_sample_wilcoxon(L, H, "two.sided")
```
...
```{r}
talker_L_w <- get_two_sample_wilcoxon(SL, TL, "two.sided")
talker_H_w <- get_two_sample_wilcoxon(SH, TH, "two.sided")
meaning_L_w <- get_two_sample_wilcoxon(ML, NL, "two.sided")
meaning_H_w <- get_two_sample_wilcoxon(MH, NH, "two.sided")
```
...
```{r}
# save(overall_w, one_sample_w, two_sample_w, interaction_w, interaction_two_sample_w, file = "8_wilcoxon/data/wilcoxon_results.RData")
save(S_w, T_w, M_w, N_w, L_w, H_w, talker_w, meaning_w, constraint_w, SH_w, SL_w, TH_w, TL_w, file = "4_test_cross_correlations/data/wilcoxon_results.RData")
```
