...
# Import data
fpath = paste("4_test_cross_correlations/data/", NORM, ALT, "_wilcoxon_results_f0.RData", sep = "")
load(fpath) 
```
...
plot
fname = paste('figs/', NORM, ALT, '_overall_f0.png', sep = "")
...
plot
fname = paste('figs/', NORM, ALT, '_talker_f0.png', sep = "")
...
plot
fname = paste('figs/', NORM, ALT, '_meaning_f0.png', sep = "")
ggsave(plot = plot, filename = fname, width = 12, height = 5)
```
...
plot
fname = paste('figs/', NORM, ALT, '_constraint_f0.png', sep = "")
ggsave(plot = plot, filename = fname, width = 12, height = 5)
```
