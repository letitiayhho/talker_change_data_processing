...
# Import data
BAND = "above_f0"
fpath = paste("4_test_cross_correlations/data/wilcoxon_results_", BAND, '.RData', sep = "")
load(fpath) 
```
...
plot
fname = paste('figs/', BAND, '_overall.png', sep = "")
...
plot
fname = paste('figs/', BAND, '_talker.png', sep = "")
...
plot
fname = paste('figs/', BAND, '_meaning.png', sep = "")
ggsave(plot = plot, filename = fname, width = 12, height = 5)
```
...
plot
fname = paste('figs/', BAND, '_constraint.png', sep = "")
ggsave(plot = plot, filename = fname, width = 12, height = 5)
```
...
# plot
# fname = paste('figs/', BAND, '_talker_L_poster.png', sep = "")
# ggsave(plot = plot, filename = fname, width = 12, height = 5)
```
...
# plot
# fname = paste('figs/', BAND, '_talker_H_poster.png', sep = "")
# ggsave(plot = plot, filename = fname, width = 12, height = 5)
```
...
# plot
# fname = paste('figs/', BAND, '_meaning_L_poster.png', sep = "")
# ggsave(plot = plot, filename = fname, width = 12, height = 5)
```
...
# plot
# fname = paste('figs/', BAND, '_meaning_H_poster.png', sep = "")
# ggsave(plot = plot, filename = fname, width = 12, height = 5)
```
**stats**
