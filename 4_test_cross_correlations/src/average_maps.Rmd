...
# Get p-values for tracking within each level
low <- get_ps(L_w$p, constraint_channels)
high <- get_ps(H_w$p, constraint_channels)
nodiff_low <- get_ps(L_w$p, nodiff_constraint)
nodiff_high <- get_ps(H_w$p, nodiff_constraint)
