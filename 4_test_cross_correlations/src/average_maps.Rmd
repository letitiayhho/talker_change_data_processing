...
plot
fname = paste('figs/', NORM, ALT, '_overall_poster.png', sep = "")
ggsave(plot = plot, filename = fname, width = 12, height = 10, dpi = 500)
```
...
plot
fname = paste('figs/', NORM, ALT, '_talker_poster.png', sep = "")
ggsave(plot = plot, filename = fname, width = 24, height = 10, dpi = 500)
```
...
plot
fname = paste('figs/', NORM, ALT, '_meaning_poster.png', sep = "")
ggsave(plot = plot, filename = fname, width = 24, height = 10, dpi = 500)
```
...
plot
fname = paste('figs/', NORM, ALT, '_constraint_poster.png', sep = "")
ggsave(plot = plot, filename = fname, width = 24, height = 10, dpi = 500)
```
...
plot
fname = paste('figs/', NORM, ALT, '_talker_L_poster.png', sep = "")
ggsave(plot = plot, filename = fname, width = 24, height = 10, dpi = 500)
```
...
plot
fname = paste('figs/', NORM, ALT, '_talker_H_poster.png', sep = "")
ggsave(plot = plot, filename = fname, width = 24, height = 10, dpi = 500)
```
...
plot
fname = paste('figs/', NORM, ALT, '_meaning_L_poster.png', sep = "")
ggsave(plot = plot, filename = fname, width = 24, height = 10, dpi = 500)
```
...
plot
fname = paste('figs/', NORM, ALT, '_meaning_H_poster.png', sep = "")
ggsave(plot = plot, filename = fname, width = 24, height = 10, dpi = 500)
```
**stats**
