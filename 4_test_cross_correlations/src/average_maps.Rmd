...
# Import data
fpath = paste("4_test_cross_correlations/data/", ALT, "_wilcoxon_results.RData", sep = "")
load(fpath) 
```
...
plot
fname = paste('figs/', ALT, '_overall.png', sep = "")
ggsave(plot = plot, filename = fname, width = 6, height = 5)
```
...
plot
fname = paste('figs/', ALT, '_talker.png', sep = "")
...
plot
fname = paste('figs/', ALT, '_meaning.png', sep = "")
ggsave(plot = plot, filename = fname, width = 12, height = 5)
```
...
plot
fname = paste('figs/', ALT, '_constraint.png', sep = "")
ggsave(plot = plot, filename = fname, width = 12, height = 5)
```
...
sum(overall_w$p < 0.01)

print("number of talker norm channels")
length(talker_channels)
print("number of different-talker channels (p < 0.01)")
sum(T_w$p < 0.01, na.rm = TRUE)
print("number of same-talker channels (p < 0.01)")
sum(S_w$p < 0.01, na.rm = TRUE)

print("number of meaning channels")
length(meaning_channels)
print("number of meaningful channels (p < 0.01)")
sum(M_w$p < 0.01, na.rm = TRUE)
print("number of nonsense channels (p < 0.01)")
sum(N_w$p < 0.01, na.rm = TRUE)

print("number of constraint channels")
length(constraint_channels)
print("number of low-constraint channels (p < 0.01)")
sum(L_w$p < 0.01, na.rm = TRUE)
print("number of high-constraint channels (p < 0.01)")
sum(H_w$p < 0.01, na.rm = TRUE)
```
...
plot
fname = paste('figs/', ALT, '_talker_L.png', sep = "")
ggsave(plot = plot, filename = fname, width = 12, height = 5)
```
...
plot
fname = paste('figs/', ALT, '_talker_H.png', sep = "")
ggsave(plot = plot, filename = fname, width = 12, height = 5)
```
...
plot
fname = paste('figs/', ALT, '_meaning_L.png', sep = "")
ggsave(plot = plot, filename = fname, width = 12, height = 5)
```
...
plot
fname = paste('figs/', ALT, '_meaning_H.png', sep = "")
ggsave(plot = plot, filename = fname, width = 12, height = 5)
```
**stats**
...
sum(TL_w$p < 0.01, na.rm = TRUE)
print("number of same-talker channels (p < 0.05)")
sum(SL_w$p < 0.01, na.rm = TRUE)
...
print("number of meaningful channels (p < 0.01)")
sum(ML_w$p < 0.01, na.rm = TRUE)
print("number of nonsense channels (p < 0.01)")
sum(NL_w$p < 0.01, na.rm = TRUE)

print("number of meaning channels for high constraint")
length(meaning_H_interaction_channels)
print("number of meaningful channels (p < 0.01)")
sum(MH_w$p < 0.01, na.rm = TRUE)
print("number of nonsense channels (p < 0.01)")
sum(NH_w$p < 0.01, na.rm = TRUE)
```
