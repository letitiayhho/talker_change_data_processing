...
```{r}
# Import data
xcorr <- read.csv(file = "3_cross_correlate/data/maximum_normalized.csv")
...
```{r}
overall <- get_subject_averages(xcorr) # Averages across all conditions within each subject
