...
ggsave(distances_hist, filename = '7_cluster_coherencee/figs/distances.png', width = 8, height = 6)
...
ggsave(inverse_distances_hist, filename = '7_cluster_coherence/figs/inverse_normed_distances.png', width = 8, height = 6)
