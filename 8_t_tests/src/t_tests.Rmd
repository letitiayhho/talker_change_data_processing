...
xcorr_norm <- read.csv(file = "8_t_tests/data/archive/average_resample_audio_norm.csv")
xcorr_nonorm_noresample <- read.csv(file = "8_t_tests/data/archive/average_nonorm_noresample.csv")
xcorr_resample_eeg_norm <- read.csv(file = "8_t_tests/data/abs_average.csv")
...
#### Cross-correlation not normalized, audio not downsampled to 1k

```{r}
same_talker <- get_one_sample_t(subset(xcorr_nonorm_noresample, condition = "talker", level = "S"))
different_talker <- get_one_sample_t(subset(xcorr_nonorm_noresample, condition = "talker", level = "T"))
meaningful <- get_one_sample_t(subset(xcorr_nonorm_noresample, condition = "meaning", level = "M"))
nonsense <- get_one_sample_t(subset(xcorr_nonorm_noresample, condition = "meaning", level = "N"))
low_constraint <- get_one_sample_t(subset(xcorr_nonorm_noresample, condition = "constraint", level = "L"))
high_constraint <- get_one_sample_t(subset(xcorr_nonorm_noresample, condition = "constraint", level = "H"))
```
