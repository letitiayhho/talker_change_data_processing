...
observed_filename <- paste("threshold_free_clustering_coherence/data/cluster_scores/", condition, "_observed.RDS", sep = "")
saveRDS(observed, file = observed_filename)
permutations_filename <- paste("threshold_free_clustering_coherence/data/cluster_scores/", condition, "_permutations.RDS", sep = "")
