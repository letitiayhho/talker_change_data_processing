get_mni_coordinates <- function(coordinates_file_name = "average_channel_locations.sfp",
  ...
  get_coordinates <- function(coordinates_file_name) {
    coordinates_fp <- file.path("/Users/letitiaho/src/talker-change-data-processing/3_channel_locations/data", coordinates_file_name)
  ...
  if (save_output == TRUE) {
    ...
    save_file_fp <- file.path("/Users/letitiaho/src/talker-change-data-processing/3_channel_locations/data", save_file)
