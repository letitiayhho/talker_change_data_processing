...
spacer <- matrix(" ", 128, 1)
overall <- data.frame(channels, 'p'= w$p)
...
save(S_w, T_w, M_w, N_w, L_w, H_w, talker_w, meaning_w, constraint_w, SH_w, SL_w, TH_w, TL_w, file = "8_wilcoxon/data/full_wilcoxon_results.RData")
```
