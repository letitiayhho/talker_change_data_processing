...
# get_frequency_table(t_xcorr_talker_s, title = "Table 2. Same talker")
t_xcorr_talker_t <- get_one_sample_t(subset(xcorr, condition = "talker", level = "T"))
get_combined_frequency_table(t_xcorr_talker_s, t_xcorr_talker_t, 
                             title = "Table 3. Talker", group1 = "Same talker", group2 = "Different talker")
```
...
get_combined_frequency_table(t_xcorr_meaning_m, t_xcorr_meaning_n, 
                             title = "Table 4. Nonsense", group1 = "Meaningful", group2 = "Nonsense")
```
...
get_combined_frequency_table(t_xcorr_constraint_s, t_xcorr_constraint_g, 
                             title = "Table 5. Low constraint", group1 = "High constraint", group2 = "Low constraint")
```
...
get_frequency_table(t_xcorr_talker_paired, title = "Table 8. Talker")
...
get_frequency_table(t_xcorr_meaning_paired, title = "Table 9. Meaning")
...
get_frequency_table(t_xcorr_constraint_paired, title = "Table 10. Constraint")
```
