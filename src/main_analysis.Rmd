...
# Meaning
xcorr_meaning_paired <- get_paired_samples_t(xcorr_meaning$M, xcorr_meaning$N)
conv_meaning_paired <- get_paired_samples_t(conv_meaning$M, conv_meaning$N)
get_combined_frequency_table(xcorr_meaning_paired, conv_meaning_paired, title = "Table 10. Meaning")

# Constraint
xcorr_constraint_paired <- get_paired_samples_t(xcorr_constraint$S, xcorr_constraint$G)
conv_constraint_paired <- get_paired_samples_t(conv_constraint$S, conv_constraint$G)
...
kable(level_p_values, escape = F, col.names = c("Channel", "XCorr", "Conv", "XCorr", "Conv", "Paired", 
...
# paired_talker_2 <- get_paired_samples_t(filter(xcorr, talker == "S"), filter(xcorr, talker == "T"))
