...
f0_talker <- subset_condition(f0, "talker")
f0_meaning <- subset_condition(f0, "meaning")
f0_constraint <- subset_condition(f0, "constraint")
f1_f2_talker <- subset_condition(f1_f2, "talker")
f1_f2_meaning <- subset_condition(f1_f2, "meaning")
f1_f2_constraint <- subset_condition(f1_f2, "constraint")
f3_talker <- subset_condition(f3, "talker")
f3_meaning <- subset_condition(f3, "meaning")
f3_constraint <- subset_condition(f3, "constraint")
```
