...
get_hot <- function(data) {
  if (labels == "Tracking") {label = c("Tracking", "Not tracking")}
  else (labels == "Distinguishing") {label = c("Distinguishing", "Not distinguishing")}
  else (labels == "Matching") {label = c(1, 0)}
  hot[which(data < 0.1)] <- label(1)
  hot[which(data > 0.1)] <- label(2)
  return(hot)
}
```
...
get_frequency_table(xcorr_talker, conv_talker, tracking = FALSE, title = "Table 9. Talker")
...
get_frequency_table(xcorr_meaning, conv_meaning, tracking = FALSE, title = "Table 10. Meaning")
...
get_frequency_table(xcorr_constraint, conv_constraint, tracking = FALSE, title = "Table 11. Constraint")
```
