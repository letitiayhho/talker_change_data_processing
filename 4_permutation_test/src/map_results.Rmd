...
plot
# ggsave(plot = plot, filename = 'figs/overall.png', width = 6, height = 6)
```
...
plot
# ggsave(plot = plot, filename = 'figs/talker.png', width = 12, height = 6)
```
...
plot
# ggsave(plot = plot, filename = 'figs/meaning.png', width = 12, height = 6)
```
...
plot
# ggsave(plot = plot, filename = 'figs/constraint.png', width = 12, height = 6)
```