...
S_hist <- histogram(weight_scores$S, title = "S", xlim = c(0.5, 1.5))
T_hist <- histogram(weight_scores$T, title = "T", xlim = c(0.5, 1.5))
M_hist <- histogram(weight_scores$M, title = "M", xlim = c(0.5, 1.5))
N_hist <- histogram(weight_scores$N, title = "N", xlim = c(0.5, 1.5))
L_hist <- histogram(weight_scores$L, title = "L", xlim = c(0.5, 1.5))
H_hist <- histogram(weight_scores$H, title = "H", xlim = c(0.5, 1.5))
